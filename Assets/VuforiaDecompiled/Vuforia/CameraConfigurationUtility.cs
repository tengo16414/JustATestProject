...
namespace Vuforia
{
	internal static class CameraConfigurationUtility
	{
		...
		public static float ExtractVerticalCameraFoV(Matrix4x4 inverseProjMatrix)
		{
			...
			Vector3 to = CameraConfigurationUtility.HomogenizedVec3(inverseProjMatrix * CameraConfigurationUtility.MAX_TOP);
			return Vector3.Angle(arg_22_0, to);
		}
		...
		public static float ExtractHorizontalCameraFoV(Matrix4x4 inverseProjMatrix)
		{
			...
			Vector3 to = CameraConfigurationUtility.HomogenizedVec3(inverseProjMatrix * CameraConfigurationUtility.MAX_RIGHT);
			return Vector3.Angle(arg_22_0, to);
		}
