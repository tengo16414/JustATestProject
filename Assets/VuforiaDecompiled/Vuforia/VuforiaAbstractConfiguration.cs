...
namespace Vuforia
{
	public abstract class VuforiaAbstractConfiguration : ScriptableObject
	{
		...
		public class VideoBackgroundConfiguration
		{
			...
			internal static Shader GetDefaultMatteShader(HideExcessAreaAbstractBehaviour.CLIPPING_MODE mode)
			{
		...
		internal static VuforiaAbstractConfiguration CreateInstance()
		{
