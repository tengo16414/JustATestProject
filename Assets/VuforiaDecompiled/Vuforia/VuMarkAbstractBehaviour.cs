	...
	public abstract class VuMarkAbstractBehaviour : DataSetTrackableBehaviour
	{
		...
		public Vector2 Origin
		{
			get
			{
				...
				float d = this.GetSize().x / this.mBoundingBox.width;
				Vector2 arg_59_0 = this.mBoundingBox.position * d;
				Vector2 a = this.mBoundingBox.size * d;
				Vector2 b = arg_59_0 + 0.5f * a;
				return this.mOrigin * d - b;
			}
		}
