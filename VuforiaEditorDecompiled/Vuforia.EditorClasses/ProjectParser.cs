...
namespace Vuforia.EditorClasses
{
	internal static class ProjectParser
	{
		...
		private static System.Collections.Generic.List<string> GetScenesInDirectory(string root)
		{
			System.Collections.Generic.List<string> list = new System.Collections.Generic.List<string>();
			string[] array = null;
			try
			{
				array = System.IO.Directory.GetFiles(root);
			}
			catch (System.UnauthorizedAccessException arg_11_0)
			{
				Debug.LogWarning(arg_11_0.Message);
			}
			catch (System.IO.DirectoryNotFoundException arg_1D_0)
			{
			...
			if (array != null)
			{
				...
				array2 = System.IO.Directory.GetDirectories(root);
				for (int i = 0; i < array2.Length; i++)
				{
