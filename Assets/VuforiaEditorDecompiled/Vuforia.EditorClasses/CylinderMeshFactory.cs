...
namespace Vuforia.EditorClasses
{
	internal class CylinderMeshFactory
	{
		...
		private System.Collections.Generic.List<Vector3> mPositions;

		private System.Collections.Generic.List<Vector3> mNormals;

		private System.Collections.Generic.List<Vector2> mUVs;
		...
		{
			this.mPositions = new System.Collections.Generic.List<Vector3>();
			this.mNormals = new System.Collections.Generic.List<Vector3>();
			this.mUVs = new System.Collections.Generic.List<Vector2>();
			float arg_46_0 = this.ComputeHeight(this.mSideLength);
			System.Collections.Generic.List<Vector3> list = CylinderMeshFactory.CreatePerimeterPositions(0f, this.mBottomRadius, numPerimeterVertices);
			System.Collections.Generic.List<Vector3> list2 = CylinderMeshFactory.CreatePerimeterPositions(arg_46_0, this.mTopRadius, numPerimeterVertices);
			System.Collections.Generic.List<int> list3 = this.AddBodyTriangles(list, list2);
			int num = 1;
			System.Collections.Generic.List<int> list4 = null;
			if (hasBottomGeometry && this.mBottomRadius > 0f)
			{
				list4 = this.AddSealingTriangles(list, false);
				num++;
			}
			System.Collections.Generic.List<int> list5 = null;
		...
		private System.Collections.Generic.List<int> AddBodyTriangles(System.Collections.Generic.List<Vector3> bottomPerimeterVertices, System.Collections.Generic.List<Vector3> topPerimeterVertices)
		{
			...
			for (int i = 0; i < count; i++)
			{
				...
				vector3.Normalize();
				Vector3 axis = Vector3.Cross(Vector3.up, vector3) * -1f;
				Vector3 to = vector2 - vector;
				Vector3 item = Quaternion.AngleAxis(Vector3.Angle(Vector3.up, to), axis) * vector3;
				list.Add(item);
			}
		...
		private System.Collections.Generic.List<int> AddSealingTriangles(System.Collections.Generic.List<Vector3> perimeterVertices, bool isTop)
		{
			...
			for (int i = 0; i < 2; i++)
			{
				...
				{
					System.Collections.Generic.List<int> arg_ED_0 = list;
					System.Collections.Generic.IEnumerable<int> arg_ED_1;
					if (!flag)
					{
				...
				System.Collections.Generic.List<int> arg_12E_0 = list;
				System.Collections.Generic.IEnumerable<int> arg_12E_1;
				if (!flag)
				{
		...
		private static System.Collections.Generic.List<Vector3> CreatePerimeterPositions(float height, float radius, int numPerimeterVertices)
		{
			System.Collections.Generic.List<Vector3> list = new System.Collections.Generic.List<Vector3>();
		...
		private static System.Collections.Generic.List<Vector2> CreatePerimeterUVCoordinates(int numPerimeterVertices, bool isTop)
		{
		...
		{
			return (double)System.Math.Abs(this.mBigRadius - this.mSmallRadius) < 1E-05;
		}
