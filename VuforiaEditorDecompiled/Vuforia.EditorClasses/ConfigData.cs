...
namespace Vuforia.EditorClasses
{
	internal class ConfigData
	{
		...
		public struct ImageTargetData
		{
			...
			public System.Collections.Generic.List<ConfigData.VirtualButtonData> virtualButtons;
		...
		{
			public System.Collections.Generic.List<ConfigData.MultiTargetPartData> parts;
		}
		...
		private System.Collections.Generic.Dictionary<string, ConfigData.ImageTargetData> imageTargets;

		private System.Collections.Generic.Dictionary<string, ConfigData.MultiTargetData> multiTargets;

		private System.Collections.Generic.Dictionary<string, ConfigData.CylinderTargetData> cylinderTargets;

		private System.Collections.Generic.Dictionary<string, ConfigData.ObjectTargetData> objectTargets;

		private System.Collections.Generic.Dictionary<string, ConfigData.VuMarkData> vuMarkTargets;
		...
		{
			this.fullPath = path;
			this.imageTargets = new System.Collections.Generic.Dictionary<string, ConfigData.ImageTargetData>();
			this.multiTargets = new System.Collections.Generic.Dictionary<string, ConfigData.MultiTargetData>();
			this.cylinderTargets = new System.Collections.Generic.Dictionary<string, ConfigData.CylinderTargetData>();
			this.objectTargets = new System.Collections.Generic.Dictionary<string, ConfigData.ObjectTargetData>();
			this.vuMarkTargets = new System.Collections.Generic.Dictionary<string, ConfigData.VuMarkData>();
		}

		public ConfigData(ConfigData original)
		{
			this.fullPath = original.FullPath;
			this.imageTargets = new System.Collections.Generic.Dictionary<string, ConfigData.ImageTargetData>(original.imageTargets);
			this.multiTargets = new System.Collections.Generic.Dictionary<string, ConfigData.MultiTargetData>(original.multiTargets);
			this.cylinderTargets = new System.Collections.Generic.Dictionary<string, ConfigData.CylinderTargetData>(original.cylinderTargets);
			this.objectTargets = new System.Collections.Generic.Dictionary<string, ConfigData.ObjectTargetData>(original.objectTargets);
			this.vuMarkTargets = new System.Collections.Generic.Dictionary<string, ConfigData.VuMarkData>(original.vuMarkTargets);
		}
		...
		{
			using (System.Collections.Generic.Dictionary<string, ConfigData.ImageTargetData>.ValueCollection.Enumerator enumerator = this.imageTargets.Values.GetEnumerator())
			{
		...
		public void GetVirtualButton(string name, string imageTargetName, out ConfigData.VirtualButtonData vb)
		{
			...
			try
			{
				...
				System.Collections.Generic.List<ConfigData.VirtualButtonData> virtualButtons = imageTargetData.virtualButtons;
