	...
	internal abstract class BaseStereoViewerCameraConfiguration : BaseCameraConfiguration
	{
		...
		public virtual void ConfigureVideoBackground()
		{
			...
			else
			{
				...
				flag = (surfaceOrientation == ScreenOrientation.LandscapeLeft || surfaceOrientation == ScreenOrientation.LandscapeLeft || surfaceOrientation == ScreenOrientation.LandscapeRight);
			}
			if (flag)
			{
		...
		protected void ComputeViewPortRect(int leftCameraViewPortHeight, int leftCameraViewPortWidth)
		{
			...
			ScreenOrientation surfaceOrientation = SurfaceUtilities.GetSurfaceOrientation();
			float num4;
			if (surfaceOrientation == ScreenOrientation.LandscapeLeft || surfaceOrientation == ScreenOrientation.LandscapeLeft || surfaceOrientation == ScreenOrientation.LandscapeRight)
			{
