	...
	internal class SceneManager
	{
		...
		public static SceneManager Instance
		{
			get
			{
				...
				{
					System.Type typeFromHandle = typeof(SceneManager);
					lock (typeFromHandle)
					{
						if (SceneManager.mInstance == null)
						{
		...
		private SceneManager()
		{
			...
			{
				EditorApplication.update = (EditorApplication.CallbackFunction)System.Delegate.Combine(EditorApplication.update, this.mUpdateCallback);
			}
