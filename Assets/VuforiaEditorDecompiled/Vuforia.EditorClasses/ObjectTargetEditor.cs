...
namespace Vuforia.EditorClasses
{
	...
	public class ObjectTargetEditor : Editor
	{
		...
		{
			if (VuforiaUtilities.GetPrefabType(otb) == 1)
			{
				return;
			}
		...
		{
			ObjectTargetAbstractBehaviour arg_22_0 = (ObjectTargetAbstractBehaviour)base.get_target();
			this.mSerializedObject = new SerializedObjectTarget(base.get_serializedObject());
		...
		public override void OnInspectorGUI()
		{
			...
			if (ConfigDataManager.Instance.NumConfigDataObjects > 1)
			{
				...
				{
					bool flag = VuforiaUtilities.DrawDatasetTrackableInspector(this.mSerializedObject, false, new System.Func<ConfigData, string[]>(ObjectTargetEditor.GetTrackableNames), "Object Target");
