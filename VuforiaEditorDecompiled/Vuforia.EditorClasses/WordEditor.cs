...
namespace Vuforia.EditorClasses
{
	...
	public class WordEditor : Editor
	{
		...
		public static void EditorConfigureTarget(WordAbstractBehaviour wb, SerializedWord serializedObject)
		{
			...
			if (VuforiaUtilities.GetPrefabType(wb) == 1)
			{
				return;
			}
		...
		{
			WordAbstractBehaviour arg_22_0 = (WordAbstractBehaviour)base.get_target();
			this.mSerializedObject = new SerializedWord(base.get_serializedObject());
		...
		public override void OnInspectorGUI()
		{
			...
			if (GUI.changed)
			{
				WordEditor.UpdateMesh((WordAbstractBehaviour)base.get_target());
		...
		private static Bounds GetBoundsForAxisAlignedTextMesh(TextMesh textMesh)
		{
			...
			Vector3 center = new Vector3(bounds2.min.x, bounds2.min.z, 0f) + 0.5f * vector;
