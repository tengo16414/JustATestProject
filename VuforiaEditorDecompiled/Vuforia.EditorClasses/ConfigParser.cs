...
namespace Vuforia.EditorClasses
{
	internal class ConfigParser
	{
		...
		public bool fileToStruct(string configXMLPath, string authoringInfoXMLPath, ConfigData configData)
		{
			...
			if (System.IO.File.Exists(authoringInfoXMLPath))
			{
			...
			System.Collections.Generic.List<ConfigData.CylinderTargetData> list = new System.Collections.Generic.List<ConfigData.CylinderTargetData>();
			System.Collections.Generic.List<ConfigData.ObjectTargetData> list2 = new System.Collections.Generic.List<ConfigData.ObjectTargetData>();
						...
						if (num <= 2826972859u)
						{
							...
							else if (name == "CylinderTarget")
							{
								...
								else
								{
									...
									if (attribute5 != null)
									{
										sideLength = float.Parse(attribute5, System.Globalization.CultureInfo.InvariantCulture);
									}
									xmlTextReader.MoveToElement();
						...
						else if (num <= 3803554136u)
						{
							...
							else if (name == "MultiTarget")
							{
								...
								else
								{
									...
									{
										parts = new System.Collections.Generic.List<ConfigData.MultiTargetPartData>()
									}, attribute9);
								}
							}
						}
									...
									else
									{
										...
										else
										{
											...
											for (int i = 0; i < array4.Length; i++)
											{
												...
												Quaternion rhs = this.parseQuaternionFromAttrString(text);
												quaternion *= rhs;
											}
											xmlTextReader.MoveToElement();
			...
			if (list2.Count > 0)
			{
				...
				else if (System.IO.File.Exists(text4))
				{
