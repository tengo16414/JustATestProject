...
namespace Vuforia.EditorClasses
{
	internal class DatabaseLoadEditor : ConfigurationEditor
	{
		...
		internal static bool OnConfigDataChanged()
		{
			...
			System.Collections.Generic.List<string> list = expr_45.DataSetsToActivate.ToList<string>();
			list.RemoveAll((string s) => System.Array.Find<string>(dataSetList, (string str) => str.Equals(s)) == null);
